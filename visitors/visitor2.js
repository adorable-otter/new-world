...
function review() {
    ...
    createBookPage({ name: '박준석', comment: '다들 처음 시작하는 거라 어려움이 많았음에도 불구하고 누구 한 명 소극적인 모습 없이\n적극적으로 다 같이 고민하고 해결하려는 모습이 보였습니다.\n한 층 더 성장할 수 있는 좋은 시간이었습니다.', profileImg: 'https://postfiles.pstatic.net/MjAyNDEwMDNfMjIx/MDAxNzI3OTUwMTczNjE3.bzMWKXJ7-FT_Eov94hhcmueiVcdLI6KZp4a1sUgvLQYg.s79DijTJYJp8LU7WK2W2l7dgH1KgZwO8u2vODYyTvzUg.JPEG/%EB%B0%95%EC%A4%80%EC%84%9D.jpg?type=w966' });
    ...
    createBookPage({ name: '신상용', comment: '이번 프로젝트를 진행하며 여러 사람들과 결과물을 만들어내는 것에 성취감을 느낄 수 있었으며\n많은 시간을 쓰기보다는 시간을 효율적으로 쓰는 것에 소중함을 느낄 수 있었습니다.', profileImg: 'https://postfiles.pstatic.net/MjAyNDEwMDNfMjQ2/MDAxNzI3OTU0NjIyNTUw.15wTdBcrHsuMMefovXxyvZnFvPBcdpU5WSJyw6V101cg.BYH2HEG3w9a4rFyrZqStZQo0gfAT8dsmHpm9lh9Dv2kg.JPEG/%EC%8B%A0%EC%83%81%EC%9A%A9.jpg?type=w966' });
}